...
class sizeController{
    ...
    getid(req,res,next){
        ...
        const mant= req.params.id;
            const query= "select * from zise where idSize=?";
    ...
    deleteId(req,res,next){
        ...
        try {
            const query= "delete from zise where idSize=?";
            connection.query(query, [mant], (error, result)=>{
                if(error) throw error
    ...
    addSize(req,res,next){
        ...
        console.log('values')
        try {
            const query= "insert into zise(idSize,nameSize) values (?,?)";
    ...
    updateSize(req,res,next){
        ...
        console.log('values')
        try {
            const query= "update zise set nameSize=? where idSize=?";
