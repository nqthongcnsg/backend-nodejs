...
class typeController{
    ...
    getid(req,res,next){
        ...
        const mant= req.params.id;
            const query= "select * from type where idType=?";
    ...
    deleteId(req,res,next){
        ...
        try {
            const query= "delete from type where idType=?";
            connection.query(query, [mant], (error, result)=>{
                if(error) throw error
    ...
    addType(req,res,next){
        ...
        console.log('values')
        try {
            const query= "insert into type(idType,nameType) values (?,?)";
    ...
    updateType(req,res,next){
        ...
        console.log('values')
        try {
            const query= "update type set nameType=? where idType=?";
